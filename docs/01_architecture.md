...
Local Spark training project for Raw profiling, Bronze ingestion, Silver cleaning, quality, and
audit foundations.
...
- Gold, benchmark, serving, Trino, and streaming work is tracked in the roadmap, not as runtime
  package modules, until each phase has implemented behavior.
...
| `src/spark_log_lab/schemas/` | Raw, Bronze, and Silver schema definitions |
...
| `src/spark_log_lab/metadata/` | Run context and audit helpers |
